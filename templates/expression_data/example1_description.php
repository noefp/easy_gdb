...
<p>
  It is also possible to add here some figures or images related to this experiment that cuold be interesting, 
  such as photos showing the phenotype for the developmental stages or experimental conditions included in this dataset.
</p>
<img class='rounded' src='<?php echo "$images_path/people/placeholder1.png";?>' width="150px" alt='img example'>
<img class='rounded' src='<?php echo "$images_path/people/placeholder2.png";?>' width="150px" alt='img example'>
<img class='rounded' src='<?php echo "$images_path/people/placeholder1.png";?>' width="150px" alt='img example'>
<br>
