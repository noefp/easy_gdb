...
<?php
  ...
  if($output)
  {
    ...
    // TABLE BEGIN
    echo "<div id=\"Annot_table_$table_counter\" class=\"collapse\"><table id=\"tblAnnotations_$table_counter\" class=\"tblAnnotations table table-striped table-bordered\"style=\"display:none\">\n";
