...
<a href="/easy_gdb/tools/expression/expression_input_private.php" class="float-left" style="text-decoration: underline;"><i class="fas fa-reply" style="color:#229dff"></i> Back to input</a>
...
<?php
  ...
  if ( file_exists("$private_expression_path/expression_info.json") ) {
    $annot_json_file = file_get_contents("$private_expression_path/expression_info.json");
...
if ( file_exists("$private_expression_path/expression_info.json") ) {
  ...
  if ($annot_hash[$dataset_name_ori]["cartoons"]) {
    ...
    if ($expr_cartoons && file_exists($private_expression_path."/$cartoon_conf") ) {
      
      $cartoons_json = file_get_contents($private_expression_path."/$cartoon_conf");
