  ...
  <br>
      ...
      <h1 style="font-size:26px">Explore gene expression</h4>
        ...
        Clicking on the <kbd>Get Expression</kbd> button will return the expression output for those genes.
			...
			<center>
				<img id="input_fig1" src='<?php echo "/easy_gdb/help/help_images/input.png";?>' width="100%"></a>
				<br>
			...
			<center>
				<img id="lines_fig1" src='<?php echo "/easy_gdb/help/help_images/lines.png";?>' width="80%"></a>
				<br>
				Figure 2. Expression viewer lines plot.
				<br>
				<br>
				<br>
				<img id="lines_fig2" src='<?php echo "/easy_gdb/help/help_images/lines_example.png";?>' width="100%"></a>
				<br>
			...
			<center>
				<img id="cards_fig3" src='<?php echo "/easy_gdb/help/help_images/cards.png";?>' width="80%"></a>
				<br>
			...
			<center>
				<img id="heatmap_fig4" src='<?php echo "/easy_gdb/help/help_images/heatmap.png";?>' width="80%"></a>
				<br>
				Figure 5. Heatmap visualization of the expression viewer.
				<br>
				<br>
				<br>
				<img id="heatmap_fig5" src='<?php echo "/easy_gdb/help/help_images/heatmap_example.png";?>' width="100%"></a>
				<br>
			...
			<center>
				<img id="replicates_fig6" src='<?php echo "/easy_gdb/help/help_images/replicates.png";?>' width="80%"></a>
				<br>
			...
			<center>
				<img id="average_fig7" src='<?php echo "/easy_gdb/help/help_images/average.png";?>' width="80%"></a>
				<br>
