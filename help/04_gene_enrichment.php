...
<div class="width900">
	...
	<br>
      ...
      <h1 style="font-size:26px">Gene Set Enrichment</h4>
			...
			<center>
				<img id="input_fig1" src='<?php echo "$images_path/help/input_enrichment.png";?>' width="100%"></a>
				<br>
				Figure 1. Gene set enrichment main page.
				<br>
				<br>
				<br>
				<img id="output_fig2" src='<?php echo "$images_path/help/output_enrichment.png";?>' width="100%"></a>
				<br>
