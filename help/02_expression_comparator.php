...
<div class="width900">
	...
	<br>
			...
			<center>
				<img id="input_fig1" src='<?php echo "$images_path/help/input_comparator.png";?>' width="100%"></a>
				<br>
			...
			<center>
				<img id="lines_fig2" src='<?php echo "$images_path/help/lines_comparator.png";?>' width="100%"></a>
				<br>
				...
				<center>
				<img id="lines_fig3" src='<?php echo "$images_path/help/lines_comparator_highlight.png";?>' width="100%"></a>
				<br>
